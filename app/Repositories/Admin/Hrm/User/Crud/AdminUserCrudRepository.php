...
namespace App\Repositories\Admin\Hrm\User\Crud;

use App\Http\Requests\Admin\Hrm\User\Crud\ValidateUpdateAdminUser;
...
class AdminUserCrudRepository extends BaseRepository implements IAdminUserCrudRepository {
    ...
    {
       $where = ($id == null) ? [...$this->baseCondition,['admin_user_role_id','=',$request->admin_user_role_id]] : [];
       return $this->getPageDefault(model: $this->AdminUser, id: $id,where: $where);
    }
    ...
    {
        $model = AdminUser::where([...$this->baseCondition,['admin_user_role_id','=',$request->admin_user_role_id]]);
    ...
    public function store($request) : JsonResponse
    {
        ...
        try {
            ...
            $m->admin_user_role_id = $request->admin_user_role_id;
